...
La implementación confirma la Spec de beta reader review sin cambiar su intención.

## Sincronización final

- La autoridad real se calcula desde una revisión copyedit/proofreading aprobada y el nodo editorial dependency-ready.
