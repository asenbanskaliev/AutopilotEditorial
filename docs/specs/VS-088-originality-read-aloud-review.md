# VS-088 — Originality and read-aloud review

## Intent

Ejecutar una pasada reproducible de originalidad y lectura en voz alta sobre una revisión beta-reader aprobada y vigente antes de cerrar el ciclo profesional.

## Behaviors

1. La revisión declara workspace, proyecto, plan editorial, revisión beta-reader, snapshot, rule set, actor y evidencia causal exacta.
2. Solo una revisión `VS-087` aprobada, vigente y asociada al nodo `originality/read-aloud` dependency-ready puede autorizar la revisión.
3. La evaluación cubre similitud indebida, clichés, repetición, cadencia, tropiezos de lectura, pronunciación, sonoridad y fluidez.
...
- No existe revisión sin autoridad exacta desde `VS-087`.
- Una revisión no puede mezclar workspaces, proyectos, planes, revisiones beta-reader o snapshots.
...
- Autoridad exacta desde la revisión beta-reader aprobada.
- Cobertura reproducible de originalidad, cadencia, pronunciación y fluidez.
